<div class="view">
	...
	Страница просмотра<br /><input value="{view_img}" size="100" class="code_fields"/><br />
	...
	<input value="{html_img}" size="100" class="code_fields" /><br />
	<br />
	...
	<input value="{html_prev_and_img}" size="100" class="code_fields" /><br />
	<br />[/one_img_prev]
</div>
